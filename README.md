...
```sh
git clone https://github.com/jessie-young/trigger.dev-github-stars-to-slack.git
cd trigger.dev-github-stars-to-slack
npm install
```
...
The easiest way to fire off the `newStarEvent` is to go ahead and star the repo (in this case it's [this repo](https://github.com/jessie-young/trigger.dev-github-stars-to-slack)). Head back to the Workflow Overview page and you should see a run is in progress:
...
<a href="https://render.com/deploy?repo=https://github.com/jessie-young/trigger.dev-github-stars-to-slack">
